...
%FIG_STATS_BOOTSTRAP SI hierarchical bootstrap on % change (median) per study.
%
...
%   the rate-summary scripts, runs a hierarchical bootstrap over
...
%
%   Prints a supplementary sensitivity summary line for each metric.
%
% INPUTS:
%   study  -  'doi' or 'ket'.
%
...
%   stats  -  Struct with .spike and .burst fields (see above).
    ...
    fprintf('  Bootstrap BH-FDR sensitivity (rate family): spike p_BH=%.4f, burst p_BH=%.4f\n', ...
