...
%   drawn as short vertical ticks. The matching trace panel is produced by
...
% See also: FIG_RATE_PANEL_TRACES, LOAD_PAIR_SPIKES, LOAD_CACHE.
    ...
    plot_raster_column(axB, bSpikes, bMeta.durationSec, ...
        labels.baseline, opt.tickWidth, style);

    axT = nexttile(tl, 2);
    plot_raster_column(axT, tSpikes, tMeta.durationSec, ...
        labels.treatment, opt.tickWidth, style);
...
% =========================================================================
function plot_raster_column(ax, spikeTimes, durSec, ttl, tickW, style)
