...
%SAVE_FIGURE Export a clean panel to vector PDF and/or raster PNG.
%
...
%   editable panel artifact; the PNG companion is for contexts that need
%   raster images.
%
...
%
% Name-value options:
%   'dpi'     -  Raster resolution for PNG output and for any
...
%   - The 600-dpi PDF is the canonical panel deliverable.
