...
% Figure output
% =========================================================================
% 'pdf+png'   writes both (canonical panel PDF plus PNG companion)
% 'pdf'       PDF only
% 'png'       PNG only
...
%                      silencing) from percent-change summaries. Default false:
...
%                           [0.05 0.10 0.15 0.20] per Rubinov &
...
cfg.connectivity.density_sweep  = [0.05 0.10 0.15 0.20];
